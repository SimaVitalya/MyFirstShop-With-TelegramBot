...
<div class="py-4">
    <div class="container">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        ...
                                        <a href="" >
                                            <img height="56px" width="80px" style="margin-right: 6px;text-decoration: none"
        ...
        <a href="{{route('user.orders.index')}}" class="btn btn-outline-dark">Перейти ко всем заказам</a>
